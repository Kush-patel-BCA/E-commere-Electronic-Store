<%@ Page Title="" Language="VB" MasterPageFile="~/userMasterPage.master" AutoEventWireup="false" CodeFile="displayItem.aspx.vb" Inherits="displayItem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="100%" class="mytable">
        ...
        <asp:Button ID="Button1" runat="server"  CssClass="btndisplay" Text="Find" height="30px" 
                     width="50px" Font-Size="Large" />     
            </td>
        </tr>
        <tr>
